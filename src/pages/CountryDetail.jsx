...
export default function CountryDetail() {
  ...
  const whatsappText = encodeURIComponent(
    `Hello Hasil International! I am interested in applying for opportunities in ${country.name}. Please guide me on the process.`
  );
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-secondary/10 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <a
            href={`https://wa.me/923333315228?text=${whatsappText}`}
            target="_blank"
