...
const faqs = [
  ...
  {
    q: 'Is A.R. Recruiting Agency government-licensed?',
    a: 'Yes, we are fully licensed by the Government of Pakistan under license number 2303/SKT. Our office is located at Plaza #2, Jamia Masjid Road, near General Hospital, Cantt Board, Sialkot Cantt.',
  },
  {
  ...
  },
  {
    ...
    a: 'You can reach us via WhatsApp at 0336-7261436 or visit our office at Plaza #2, Jamia Masjid Road, near General Hospital, Sialkot Cantt.',
  },
];
...
export default function Contact() {
  ...
  const whatsappText = encodeURIComponent(
    `Hello A.R. Recruiting Agency! My name is ${form.name || '[Your Name]'}. I am interested in ${form.destination || 'overseas employment'}. ${form.message ? `Message: ${form.message}` : ''} Please contact me at ${form.phone || '[Your Phone]'}.`
  );
      ...
      <div className="grid lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-secondary/10">
          ...
          <form
            onSubmit={(e) => {
              e.preventDefault();
              window.open(`https://wa.me/923367261436?text=${whatsappText}`, '_blank');
            }}
            className="space-y-4"
          >
            <div>
            ...
            <p className="text-xs text-ink/40 text-center">
              ...
              <a href="mailto:info@arrecruiting.pk" className="text-primary hover:underline">
                info@arrecruiting.pk
              </a>
            </p>
          </form>
        </div>
        ...
        <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:03367261436" className="text-sm font-semibold text-ink hover:text-primary transition-colors">0336-7261436</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="https://wa.me/923367261436" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-ink hover:text-primary transition-colors">0336-7261436</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <a href="mailto:info@arrecruiting.pk" className="text-sm font-semibold text-ink hover:text-primary transition-colors">info@arrecruiting.pk</a>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-ink">Plaza #2, Jamia Masjid Road, Near General Hospital, Cantt Board, Sialkot Cantt, Punjab</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Address-query map */}
          <a
            href="https://www.google.com/maps/search/?api=1&query=Plaza+2+Jamia+Masjid+Road+Sialkot+Cantt"
            target="_blank"
          ...
          >
            ...
            <div className="h-28 rounded-xl bg-gradient-to-br from-background to-primary/5 flex items-center justify-center border border-secondary/10">
              <div className="text-center">
                ...
                <p className="text-xs text-ink/50 mt-1">Jamia Masjid Road, Sialkot Cantt</p>
              </div>
            </div>
          </a>
        </div>
