      ...
      >
        ...
        <div className="p-5 border-b border-white/10">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-white font-bold text-sm leading-tight">Jhelum Overseas</p>
              <p className="text-white/50 text-[10px] font-medium">Employment Promoters</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-white/10 space-y-3">
          ...
          <div className="text-xs text-white/60 space-y-1.5">
            <a href="https://www.facebook.com/joep786/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-accent transition-colors">
              <i className="fab fa-facebook" /> /joep786
            </a>
            <a href="tel:03711940342" className="flex items-center gap-2 hover:text-accent transition-colors">
              <i className="fas fa-phone" /> 0371-1940342
            </a>
            <a href="mailto:Jhelumoverseas786@gmail.com" className="flex items-center gap-2 hover:text-accent transition-colors truncate">
              <i className="fas fa-envelope" /> Jhelumoverseas786@gmail.com
            </a>
          </div>
        </div>
      </aside>
        ...
        <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-primary/10 px-4 md:px-6">
          <div className="h-14 flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center gap-2 text-xs text-ink/60">
              ...
              Main GT Rd, opposite THQ Hospital, Sohawa, Jhelum
            </div>
            <div className="flex items-center gap-3">
              <a href="https://www.facebook.com/joep786/" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-secondary transition-colors" aria-label="Facebook">
                <i className="fab fa-facebook-f text-lg" />
              </a>
              <a href="https://wa.me/923711940342" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:text-green-700 transition-colors" aria-label="WhatsApp">
