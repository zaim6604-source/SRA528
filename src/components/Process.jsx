  ...
  return (
    <section id="process" className="relative py-16 md:py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeUp>
          <div className="pill-badge bg-cta text-white mb-4 mx-auto" style={{ width: 'fit-content' }}>
          ...
          {steps.map((s, i) => (
            <FadeUp key={s.num} delay={i * 100}>
              <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center text-white border border-white/10 hover:bg-white/20 transition-colors">
                <div className="w-12 h-12 rounded-full bg-cta text-white font-extrabold text-lg flex items-center justify-center mx-auto mb-4 shadow-lg relative z-10">
                  {s.num}
                </div>
