    ...
    <div className="px-5 py-6 flex flex-col flex-1">
      ...
      <NavLink to="/" onClick={close} className="flex items-center gap-2.5 mb-1">
        ...
        <div>
          <span className="font-bold text-lg text-white">
            Hasil<span className="text-accent">.</span>
          </span>
      ...
      <div className="space-y-2.5 text-xs text-white/50">
        <p className="flex items-start gap-2.5">
          ...
          <span>M-7, Falak Naz Heights, Opp. Jinnah Terminal, Shahrah-e-Faisal, Karachi</span>
        </p>
        <p className="flex items-center gap-2.5">
          <i className="fas fa-phone text-secondary w-3.5 text-center" />
          <a href="tel:0211458892" className="hover:text-white transition-colors">021-1458892</a>
        </p>
        <p className="flex items-center gap-2.5">
          <i className="fab fa-whatsapp text-secondary w-3.5 text-center" />
          <a href="https://wa.me/923333315228" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">0333-3315228</a>
        </p>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen bg-background/30 flex">
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-secondary/10 shadow-sm lg:hidden">
          <div className="flex items-center justify-between h-14 px-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-md bg-primary flex items-center justify-center text-white font-extrabold text-xs">H</div>
              <span className="font-bold text-sm text-ink">Hasil<span className="text-primary">.</span></span>
            </div>
            <a
              href="https://wa.me/923333315228"
              target="_blank"
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-8 xl:p-10">
          <div className="max-w-5xl mx-auto route-enter">
            <Outlet />
          </div>
        </main>
      </div>
